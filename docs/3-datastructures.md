...
| --------- | ------------ | ------- | ----------- |
| <span class="mono">limit</span>     | <span class="mono">100</span>         | <span class="mono">?limit=1500</span>        | max number of records returned, set this paramater to receive beyond 'default' number of records |
